...
unsigned char multiplication_TableFor_2[] =
    {
...
unsigned char multiplication_TableFor_3[] =
    {
...
unsigned char multiplication_TableFor_9[256] =
    {
...
unsigned char multiplication_TableFor_11[256] =
    {
...
unsigned char multiplication_TableFor_13[256] =
    {
...
unsigned char multiplication_TableFor_14[256] =
    {
...
void key_expansion(unsigned char *Key)
{
    ...
    while (i < 176)
    {
        ...
        for (int j = 0; j < 4; j++)
        {
            message[j] = ExtendedKey[i - 4 + j];
        }

        if (i % 16 == 0)
        {
            unsigned char temporaryVariable = message[0];
            message[0] = message[1];
            message[1] = message[2];
            message[2] = message[3];
            message[3] = temporaryVariable;
            for (int i = 0; i < 4; i++)
            {
        ...
        for (int k = 0; k < 4; k++)
        {
            ExtendedKey[i + k] = message[k] ^ ExtendedKey[i - 16 + k];
        }
        i += 4;
    }
}
...
void mix_column(unsigned char *messages)
{
    ...
    for (int i = 0; i < 16; i++)
    {
        if (i % 4 == 0)
        {
            temp[i] = multiplication_TableFor_2[messages[i]] ^ multiplication_TableFor_3[messages[i + 1]] ^ messages[i + 2] ^ messages[i + 3];
        }
        if (i % 4 == 1)
        {
            temp[i] = multiplication_TableFor_2[messages[i]] ^ multiplication_TableFor_3[messages[i + 1]] ^ messages[i + 2] ^ messages[i - 1];
        }
        if (i % 4 == 2)
        {
            temp[i] = multiplication_TableFor_2[messages[i]] ^ multiplication_TableFor_3[messages[i + 1]] ^ messages[i - 1] ^ messages[i - 2];
        }
        if (i % 4 == 3)
        {
            temp[i] = multiplication_TableFor_2[messages[i]] ^ multiplication_TableFor_3[messages[i - 3]] ^ messages[i - 1] ^ messages[i - 2];
        }
    }
    for (int i = 0; i < 16; i++)
    {
